...
import { DEFAULT_SCAN_FREQUENCY_MINUTES, MAX_COMPETITORS } from "@/lib/constants";
 ...
 * to poll.
 */
export async function triggerManualScan(competitorId: string): Promise<ActionResult> {
  try {
